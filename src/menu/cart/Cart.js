...
class Cart extends Component {
    ...
    getCart() {
    	...
    	axios.get("http://185.166.105.6:31356/Loghmeh_war_exploded/cart", {
            headers: {
    ...
    addToCart(restaurantId, foodName, isFoodParty, foodCount) {
		...
		axios.put('http://185.166.105.6:31356/Loghmeh_war_exploded/put_cart', null,
			{ 
    ...
    removeFromCart(restaurantId, foodName, isFoodParty) {
        ...
        // event.preventDefault();
		axios.delete('http://185.166.105.6:31356/Loghmeh_war_exploded/del_cart',
			{ 
    ...
    handleFinalize() {
        ...
        event.preventDefault();
		axios.put('http://185.166.105.6:31356/Loghmeh_war_exploded/finalize', null,
			{ headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("jwt_token")
                    }}
		).then( (response) => {this.getCart()})
