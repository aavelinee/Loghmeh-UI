...
class Cart extends Component {
    ...
    getCart() {
    	...
    	axios.get("http://185.166.105.6:30138/Loghmeh/cart", {
            headers: {
    ...
    removeFromCart(restaurantId, foodName, isFoodParty) {
        ...
        // event.preventDefault();
		axios.delete('http://185.166.105.6:30138/Loghmeh/del_cart',
			{ 
    ...
    handleFinalize() {
        ...
        event.preventDefault();
		axios.put('http://185.166.105.6:30138/Loghmeh/finalize', null,
			{ headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("jwt_token")
                    }}
		).then( (response) => {this.getCart()})
