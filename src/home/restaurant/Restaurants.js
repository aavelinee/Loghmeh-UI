...
class Restaurants extends Component {
    ...
    getSearchedRestaurant(restaurantName, foodName, page) {
        ...
        axios.get("http://loghmeh-back:8080/Loghmeh_war_exploded/searched_restaurants", { params: body ,
            headers: {
    ...
    getRestaurants(page) {
        axios.get("http://loghmeh-back:8080/Loghmeh_war_exploded/ordinary_restaurants/" + (page), {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem("jwt_token")
            }
        })
