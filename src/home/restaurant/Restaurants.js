...
class Restaurants extends Component {
    ...
    getSearchedRestaurant(restaurantName, foodName, page) {
        ...
        axios.get("http://185.166.105.6:30138/Loghmeh_war_exploded/searched_restaurants", { params: body ,
            headers: {
    ...
    getRestaurants(page) {
        axios.get("http://185.166.105.6:30138/Loghmeh_war_exploded/ordinary_restaurants/" + (page), {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem("jwt_token")
            }
        })
